...
function generateFormatterExamples(formatterInfo) {
    var output = ejs.render(cat("./templates/formatter-examples.md.ejs"), formatterInfo),
        filename = "../eslint.github.io/docs/user-guide/formatter-examples.md",
        htmlFilename = "../eslint.github.io/docs/user-guide/html-formatter-example.html";

    output.to(filename);
    fs.writeFileSync(htmlFilename, formatterInfo.formatterResults.html.result);
}
